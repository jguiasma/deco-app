...
type AdminAppointment = { id: number; quote_request_id: number | null; first_name: string; last_name: string; phone: string; email: string | null; appointment_type: string; appointment_mode: string; remote_platform: string | null; scheduled_at: string | null; status: string; notes: string | null; quote_request?: { id: number; service?: { title: string } | null; quantity: string | number; unit: string | null; dimensions: string | null; description: string } | null }
