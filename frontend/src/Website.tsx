...
type AdminQuoteRequest = { id: number; first_name: string; last_name: string; phone: string; email: string | null; city: string | null; address: string | null; service_type: string | null; quantity: string | number; unit: string | null; estimated_min: string | number | null; estimated_max: string | number | null; description: string; status: string; created_at: string | null; service?: { title: string } }
